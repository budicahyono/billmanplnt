            ...
            <div class="card card-primary card-outline">
             ...
             <div class="card-body">
               ...
               <div class="alert alert-warning alert-dismissible">
                  ...
                  Harap mengikuti format excel berikut agar data Tusbung dapat berhasil di import. Silahkan download <a class="text-href" href="<?=base_url('import/Format Import Tusbung.xlsx')?>">disini</a>. Data pelanggan yang duplikat tidak akan tersimpan 2 kali, akan tetapi akan otomatis mengupdate data tersebut. 
                </div>
               
                <form  action="<?=base_url('tusbung/hasil_import')?>" method="post" enctype="multipart/form-data">
