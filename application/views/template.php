...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=base_url();?>dashboard" class="brand-link">
      <img src="<?=base_url();?>img/icon.png" alt="Billman SAYA" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Billman SAYA</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		 ...
		 <li class="nav-item menu <?php if ($title == "Tusbung Harian"  || $title == "Monitoring Harian" || $title == "Hasil Import Tusbung Harian" ) echo 'menu-is-opening menu-open' ; ?>">
            <a href="#" class="nav-link ">
              <i class="nav-icon fas fa-th-list"></i>
              <p>
                Tusbung Harian
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=base_url()?>tusbungharian" class="nav-link <?php if ($title == "Monitoring Harian") echo 'active'; ?>">
                  <i class="fas fa-chevron-circle-right nav-icon"></i>
